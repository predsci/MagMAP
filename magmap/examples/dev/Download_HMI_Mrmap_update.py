...
download_results_filename = "download_results_Mrmap_update_" + period_start.strftime("%Y-%m-%dT%H_%M_%S") + ".csv"
...
raw_data_dir = "/Users/turtle/data/oft/hmi_Mrmap_update"
# map_data_dir = "/Volumes/terminus_ext/HMI_M720s/hmi_map"

# ----- End Inputs -------------------------

# initialize the helper class for HMI
hmi = drms_helpers.HMI_Mrmap_update_latlon_720s(verbose=True)
