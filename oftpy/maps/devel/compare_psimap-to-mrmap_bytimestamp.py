...
plt.savefig(png_dir + "/Br-PSI-Yang_v_radius_" + im_timestamp + ".png", dpi=600)
plt.close(1)
...
plt.savefig(png_dir + "/Br-PSI-div-Yang_v_radius_" + im_timestamp + ".png", dpi=600)
plt.close(1)
...
plt.savefig(png_dir + "/PSI-div-Yang_v_radius_" + im_timestamp + ".png", dpi=600)
plt.close(1)
